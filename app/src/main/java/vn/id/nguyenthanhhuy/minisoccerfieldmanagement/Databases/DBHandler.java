...
public class DBHandler extends SQLiteOpenHelper {
    ...
    private void insertFieldTest(@NonNull SQLiteDatabase db) {
        String INSERT_DATA = "INSERT INTO Field (id, name, status, type, createdAt) \n" +
                ...
                "('F1713084375816', '5 K', 'active', '5 a side', datetime('now'));\n";
        db.execSQL(INSERT_DATA);
    }
    ...
    private void insertCustomerTest (@NonNull SQLiteDatabase db) {
        String INSERT_DATA = "INSERT INTO Customer (id, memberShipId, name, phoneNumber, totalSpend, image, isDeleted, createdAt, updatedAt)\n" +
                ...
                "('2', '1', 'Trần Ánh Dương', '045783947593', 0, NULL, 0, datetime('now'), NULL);\n";
        db.execSQL(INSERT_DATA);
    }

    private void insertServiceTest(@NonNull SQLiteDatabase db) {
        String INSERT_DATA = "INSERT INTO \"Service\" VALUES " +
                "('1', 'Nước cam', 25000, NULL, NULL, 'Ly', 50, 0, 'Active', 0, datetime('now'), NULL)," +
                "('2', 'Nước bò hút', 200000, NULL, NULL, 'Lon', 50, 0, 'Active', 0, datetime('now'), NULL);";
        db.execSQL(INSERT_DATA);
    }
    private void insertBooking(@NonNull SQLiteDatabase db) {
        String INSERT_DATA = "INSERT INTO \"Booking\" VALUES " +
                "('B1713166634222','1','F1713084375810','user1','active','','2024-04-16 07:00:00.0','2024-04-16 09:00:00.0',400000.0,0,'2024-04-15 14:37:15.926',NULL)," +
                "('B1713166634223','2','F1713084375816','user1','active','','2024-04-18 07:00:00.0','2024-04-18 09:00:00.0',200000.0,0,'2024-04-15 14:37:15.926',NULL);";
        db.execSQL(INSERT_DATA);
    }

    private void insertMatchRecord(@NonNull SQLiteDatabase db) {
        String INSERT_DATA = "INSERT INTO \"MatchRecord\" VALUES " +
                "('M3097859438', 'B1713166634222', 'CHECKIN', 'CHECKOUT', 0, datetime('now'), NULL)," +
                "('M3097859439', 'B1713166634223', 'CHECKIN', 'CHECKOUT', 0, datetime('now'), NULL);";
        db.execSQL(INSERT_DATA);
    }

    private void insertServiceUsage(@NonNull SQLiteDatabase db) {
        String INSERT_DATA = "INSERT INTO \"ServiceUsage\" VALUES " +
                "('SU3097859438', 'M3097859438', '1', NULL, 0, datetime('now'), NULL)," +
                "('SU3097859439', 'M3097859439', '2', NULL, 0, datetime('now'), NULL);";
        db.execSQL(INSERT_DATA);
    }

    private void insertAppTransaction(@NonNull SQLiteDatabase db){
        String INSERT_DATA = "INSERT INTO \"AppTransaction\" VALUES " +
                "('AT3097859438', 'user1', 'SU3097859438', 'TYPE', 600000, 0, 0, 600000, 0, '2024-04-16 07:00:00.0', NULL)," +
                "('AT3097859439', 'user1', 'SU3097859439', 'TYPE', 800000, 0, 0, 800000, 0, datetime('now'), NULL);";
        db.execSQL(INSERT_DATA);
    }

    private void insertServiceItems(@NonNull SQLiteDatabase db){
        String INSERT_DATA = "INSERT INTO \"ServiceItems\" VALUES " +
                "('SI3097859438', 'SU3097859438', '1', 10, 0, datetime('now'), NULL)," +
                "('SI3097859439', 'SU3097859438', '2', 10, 0, datetime('now'), NULL);";
        db.execSQL(INSERT_DATA);
    }
